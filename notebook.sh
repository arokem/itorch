...
## pulled from https://github.com/wiseio/datascience-docker/blob/master/datascience-base/notebook.sh
##
## with changes so that this runs itorch instead of ipython
...
itorch notebook --no-browser --port 8888 --ip=* $CERTFILE_OPTION --NotebookApp.password="$HASH"